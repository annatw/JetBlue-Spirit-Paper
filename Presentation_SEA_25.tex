...
\begin{document}
    ...
    \subsection{Demand}
    \begin{frame}
        \frametitle{Demand and Supply Model}
        \begin{itemize}
            \item Standard Random-Coefficient Nested Logit Model 
            \begin{itemize} 
...
\end{tabular}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item Under a cost-benefit analysis, approval of this merger depends on 
            \begin{itemize}
                \item Weight on Low-Income Consumer Welfare
                \item Belief in Continuation of Post-Coronavirus Dynamics
            \end{itemize}
        \end{itemize}
    \end{frame} 
