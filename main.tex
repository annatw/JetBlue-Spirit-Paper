...
\end{center}
    ...
    These results are plotted in Figure \ref{fig:NEA_Market_Fare}.\footnote{The corresponding yield graph is Figure \ref{fig:NEA_Market_Yield} respectively.} While these coefficients are statistically significant and negative outside of the first two periods of the NEA, it is difficult to draw a conclusion that this is an effect of the NEA as it aligns with average fares in most of the pre-periods. 
