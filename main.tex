...
\begin{document}
    ...
    While my estimated results are consistent with efficiencies from the merger resulting in savings for the average consumers in two of the three scenarios, it is worth noting that in the judge's opinion within the case, the key risk of harm was to low-income consumers who may not be able to fly if the minimum fare within the market increased. As such, I plot the distribution of minimum fares in each simulation for the pre-pandemic and post-pandemic periods respectively in Figures \ref{fig:MinimumPrice_Pre} and \ref{fig:MinimumPrice_Post}
    
    \begin{figure}
        \caption{Minimum Market Price Effects - Pre-Pandemic}
        \label{fig:MinimumPrice_Pre}
        \includegraphics{05.Figures/PrePandemic_Merger_Change_MinimumFare.pdf}
    The best case merger scenario is one in which the combined firm inherits the minimum average cost and greatest unobservables of each firm, the average case merger scenario has the combined JetBlue-Spirit inherit the average of the two firms' product characteristics, and the worst case scenario has the combined JetBlue-Spirit inherit the greatest marginal cost and lowest unobserveables. 
    \end{figure}   

    \begin{figure}
        \caption{Minimum Market Price Effects - Post-Pandemic}
        \label{fig:MinimumPrice_Post}
        \includegraphics{05.Figures/Merger_Change_MinimumFare.pdf}
        The best case merger scenario is one in which the combined firm inherits the minimum average cost and greatest unobservables of each firm, the average case merger scenario has the combined JetBlue-Spirit inherit the average of the two firms' product characteristics, and the worst case scenario has the combined JetBlue-Spirit inherit the greatest marginal cost and lowest unobserveables. 
    \end{figure}   
