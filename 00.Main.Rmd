...
minimum_fare_percent_increase_table(table_out = "06.Tables/MinimumFareChange_Percent_25Increment.tex",
                                    buckets = c("$<$ 0", "0-25", "25-50", "50-75",
                                                    "75-100", "100 $<$"),
                                        break_points = c(-Inf, 0, 25, 50, 75, 100, Inf))
minimum_fare_percent_increase_table(table_out = "06.Tables/MinimumFareChange_Percent_25Increment_Present.tex",
                                    buckets = c("$<$ 0", "0-50", "25-50", "50 $<$"),
                                        break_points = c(-Inf, 0, 25, 50, Inf))
